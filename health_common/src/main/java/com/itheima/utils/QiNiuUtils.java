...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "BMFks1Z4RNtqaZ3uloYZduYnSswkNKxJe1uPGMWZ";
    private static final String SECRETKEY = "w2TL_vld2xM-koWEIoN1gSbscFz8-xgvexSBYL-2";
    // 对象仓库
    private static final String BUCKET = "caiciji";  //对象空间的名字
    public static final String DOMAIN= "http://qvrchngt3.hd-bkt.clouddn.com/";

    public static void main(String[] args) {

        uploadFile("C:\\itheima\\java114_SEPlus\\预习day50_传智健康\\04_资料\\图片资源\\1.jpg","C:\\itheima\\java114_SEPlus\\预习day50_传智健康\\04_资料\\图片资源\\aa.jpg");
